...
<meta name="description" content="Sistema de registro y control de ingreso de personal" />
...
<body>
  ...
  <div class="authentication-wrapper authentication-3">
    <div class="authentication-inner">
      ...
      <div class="d-none d-lg-flex col-lg-8 align-items-center ui-bg-cover ui-bg-overlay-container p-5" style="background-image: url('img/img_login.jpg');">
          ...
          <div class="w-100">
            ...
            <!-- Logo -->
			   <div class="d-flex justify-content-center align-items-center">
				<img src="img/logo_200x200.jpg" alt="Pase de Ingreso" />
			  </div>
			   <div class="d-flex justify-content-center align-items-center">
				<img src="img/logo_CC150X150.jpg" alt="Logo" />
			  </div>
            <!-- / Logo -->
