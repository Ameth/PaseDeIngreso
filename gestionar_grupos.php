...
<title><?php echo NOMBRE_PORTAL;?> | Gestionar grupos</title>
<!-- InstanceEndEditable -->
			...
			<div class="table-responsive">
                    ...
                    <?php while($row=sqlsrv_fetch_array($SQL)){?>
						 <tr class="gradeX tooltip-demo">
							...
							<td><a href="grupos.php?id=<?php echo base64_encode($row['IDGrupo']);?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']);?>&pag=<?php echo base64_encode('gestionar_grupos.php');?>&tl=1" class="alkin btn btn-link"><i class="fa fa-edit"></i> Editar</a></td>
						</tr>
					<?php }?>
                    </tbody>
                    </table>
