                    ...
                    <?php while($row=sqlsrv_fetch_array($SQL)){
						...
						?>
						 <tr>
							...
							<td><a href="informes.php?id=<?php echo base64_encode($row['IDGrupo']);?>&idped=<?php echo base64_encode($row_Periodo['IDPeriodo']);?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']);?>&pag=<?php echo base64_encode('gestionar_informes.php');?>&tl=1" class="alkin btn btn-link"><i class="fa fa-folder-open"></i> Abrir</a></td>
						</tr>
					<?php }?>
						<tr>
